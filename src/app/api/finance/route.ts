...
export async function GET(request: Request) {
  ...
  if (demoMode) {
    return NextResponse.json({
      ...
      cards: [
        { id: "c1", name: "Nubank", institution: "Nu Pagamentos", last_four: "4892", card_type: "credit", holder: "Victor Emanuel" },
        { id: "c2", name: "Cartão Atacadão", institution: "Banco CSF", last_four: "7731", card_type: "credit", holder: "Victor Emanuel" },
        { id: "c3", name: "Mercado Pago", institution: "Mercado Pago", last_four: "3309", card_type: "credit", holder: "Victor Emanuel" },
      ],
      stores: [
        { id: "s1", name: "Capitinha", credit_limit: 2000 },
        { id: "s2", name: "Farmácia São João", credit_limit: 2000 },
        { id: "s3", name: "Loja Center", credit_limit: 1500 },
      ],
    });
  }
